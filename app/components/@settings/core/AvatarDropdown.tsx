    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-bolt-elements-textTertiary group-hover:text-bolt-elements-textPrimary transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-bolt-elements-textTertiary group-hover:text-bolt-elements-textPrimary transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:download w-4 h-4 text-bolt-elements-textTertiary group-hover:text-bolt-elements-textPrimary transition-colors" />
            Download Debug Log
          </DropdownMenu.Item>
